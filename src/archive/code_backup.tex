...
\begin{figure}[H]
\centering
\includegraphics*[viewport= 80 130 725 505, width=.4\linewidth]{assets/usingLat/MobileMarketShare2006.pdf}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=.34\linewidth]{assets/usingLat/samplepng.png}
...
\lstinputlisting[caption={The Caption for the Code Listing},label={code:externalSampleCodeLabel}]{assets/usingLat/myCodeFile.java}
